...
extern bool init(string terminal_type = "v400c-plus", int baud_rate = 9600, serial::bytesize_t byte_size = serial::eightbits, serial::stopbits_t stop_bit = serial::stopbits_one, serial::flowcontrol_t xonxoff = serial::flowcontrol_none, bool rtscts = false, string port = "", int timeout = 0) {
    try {
